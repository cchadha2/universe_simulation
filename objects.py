...
import pygame
from utils import COLORS, random_position, random_velocity, calculate_distance
...
class Star(CelestialObject):
    ...
    def __init__(self, name: str, position: Tuple[float, float], velocity: Tuple[float, float]):
        mass = random.uniform(1e25, 1e26)  # Much smaller masses for stability
...
class Planet(CelestialObject):
    ...
    def __init__(self, name: str, position: Tuple[float, float], velocity: Tuple[float, float], 
        ...
        mass = random.uniform(1e20, 1e22)  # Much smaller masses for stability
        size = random.randint(6, 12)  # Larger planets
...
class Asteroid(CelestialObject):
    ...
    def __init__(self, name: str, position: Tuple[float, float], velocity: Tuple[float, float]):
        mass = random.uniform(1e12, 1e15)  # Much smaller masses for stability
...
class Nebula(CelestialObject):
    ...
    def __init__(self, name: str, position: Tuple[float, float], velocity: Tuple[float, float]):
        mass = random.uniform(1e22, 1e24)  # Much smaller masses for stability
...
class BlackHole(CelestialObject):
    ...
    def __init__(self, name: str, position: Tuple[float, float], velocity: Tuple[float, float]):
        mass = random.uniform(1e27, 1e28)  # Much smaller masses for stability
